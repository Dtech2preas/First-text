...
data class Stats(
    ...
    val routine: Map<String, Pair<Int, Int>> = emptyMap(),
    val actions: Map<String, Pair<Int, Int>> = emptyMap(),
    val firstSigns: List<SignEvent> = emptyList(),
    // Legacy fields to prevent compilation errors
...
object StaticStats {
    val data = Stats(
        ...
        lefaMsgs = 45666, owamiMsgs = 41949, lefaWords = 271591, owamiWords = 229376,
        lefaMedia = 7319, owamiMedia = 5916, lefaLove = 660, owamiLove = 705,
        lefaNaughty = 1243, owamiNaughty = 612, lefaAnnoyed = 188, owamiAnnoyed = 84,
        lefaStreak = 55, owamiStreak = 33,
        routine = mapOf("how_are_you" to (163 to 27), "sorry" to (242 to 331), "good_morning" to (350 to 297), "good_night" to (338 to 285)),
        actions = mapOf("poop" to (50 to 40), "cook" to (154 to 124), "eat" to (637 to 658), "pee" to (133 to 111), "sleep" to (499 to 724), "heading_out" to (52 to 49), "going_somewhere" to (1 to 5)),
        firstSigns = listOf(
